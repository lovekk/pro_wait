...
class Moment(models.Model):
    ...
    is_show = models.SmallIntegerField(default=0, choices=first_choices, verbose_name='是否删除')
...
class Image(models.Model):
    ...
    local_img = models.ImageField(verbose_name="本地地址",upload_to='moment/%Y/%m/%d',default="")
    publish_datetime = models.DateTimeField(auto_now_add=True, verbose_name="添加时间")
...
class Comment(models.Model):
    ...
    qiniu_img = models.CharField(max_length=100, verbose_name="评论图片七牛云", default="")
    local_img = models.ImageField(verbose_name="评论图片本地",upload_to='moment/%Y/%m/%d',default="")
    qiniu_voice = models.CharField(max_length=100, verbose_name="评论语音七牛云", default="")
    local_voice = models.FileField(verbose_name="评论语音本地",upload_to='moment_voice/%Y/%m/%d',default="")
